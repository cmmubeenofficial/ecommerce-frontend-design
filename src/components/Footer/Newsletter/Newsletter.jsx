...
function Newsletter() {
    return (
        <div className="newsletter-container flex flex-col justify-center items-center bg-[#EFF2F4] h-47.5">
            ...
            <div className="email-input-btn flex gap-3.5 relative pt-10">
                <input type="email" className="focus:outline-0 h-10 w-68.5 pl-8.75 border border-[#DEE2E7] bg-white placeholder:text-[#8B96A5] text-[15px] text-[#8B96A5] rounded-md" placeholder="Email" />
