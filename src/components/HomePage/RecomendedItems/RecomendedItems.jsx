...
function RecomendedItems() {
    return (
        <>
            <h2 className="text-xl md:text-[24px] font-semibold">Recommended items</h2>

            {/* items card */}
            <div className="item-cards grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-3 md:gap-5">
